...
export declare class ZluxFlyoverComponent implements OnInit {
    ...
    private targetHover;
    private active;
    private arrowTopOffsetLeft;
    private arrowTopOffsetBottom;
    private arrowBottomOffsetLeft;
    private arrowBottomOffsetBottom;
    private position;
    private flyoverMarginRight;
    private flyoverMarginLeft;
    private flyoverMarginTop;
    private flyoverMarginBottom;
    hideTimer: number;
    constructor(el: ElementRef);
    ngOnInit(): void;
